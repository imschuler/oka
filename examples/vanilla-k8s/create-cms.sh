...
(cd templates; kubectl create configmap ansible-templates -n $NAMESPACE --from-file=proxy.j2 --from-file=chrony.j2 --from-file=kubeadm-init.j2 --from-file=kubeadm-join.j2)
